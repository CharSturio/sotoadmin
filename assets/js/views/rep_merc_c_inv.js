function onClickAction() {
  ...
  xmlhttp.open("GET", "links/rep_merc_c_inv.php?operation=action&typeProduct=" + typeProduct);
  xmlhttp.send();
}
...
function onClickPDF() {
  ...
  var x = "invoice/pdf_rep_merc_c_inv.php?operation=action&typeProduct=" + typeProduct;
