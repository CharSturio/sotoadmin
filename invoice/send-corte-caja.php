...
if ($op === '1') {
  ...
  $total_pagos_para_credito=0;
      ...
      $html .= '<h1>Corte de Caja de ' . $desde_fecha . ' a ' .  $hasta_fecha . '</h1>';
...
$dompdf->render();
$nombre_archivo = 'CorteCaja' . $desde_fecha . 'a' . $hasta_fecha . '.pdf';
...
try {
  ...
  $mail->AltBody = 'Corte de Caja SotoGoodyear'; // optional - MsgHTML will create an alternate automatically
  $mail->MsgHTML('Corte de Caja de SotoGoodyear');
