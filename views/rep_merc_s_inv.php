<?php 
session_start();
if($_SESSION['RepMerSInvGen'] == 'true'){
  echo '<div class="header">
  <h2><strong>Reporte de Mercancia sin Inventarios</strong></h2>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="panel">
      <div class="panel-header">
        <h3><i class="icon-bulb"></i>Reporte de mercancia sin <strong>Inventarios</strong></h3>
      </div>
...
<script src="assets/js/views/rep_merc_s_inv.js"></script>
