...
if($_SESSION['MovEntMerGen'] == 'true'){
  echo '<div class="header">
	<h2><strong>Transferencia de Mercancia</strong></h2>
</div>
<div class="row">
	<div class="col-lg-12">
	  <div class="panel">
	    <div class="panel-header">
	      <h3><i class="icon-bulb"></i> Transferencia de <strong>Mercancia</strong></h3>
	    </div>
	    <div class="panel-content p-t-0">
	      <p>Selecciona el producto y la sucursal a la cual sera transferida.</p>
	      <div class="row">
	        <div class="col-md-12">
